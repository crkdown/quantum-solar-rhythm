...
const LandingMasterclass = () => {
  ...
  const texts = {
    en: {
      ...
      instructorDesc: "Health Coach · Founder of Solaris Nutri · Creator of the Solaris Nutri Framework",
    ...
    es: {
      ...
      instructorDesc: "Health Coach · Fundadora de Solaris Nutri · Creadora del Solaris Nutri Framework",
    ...
    pt: {
      ...
      instructorDesc: "Health Coach · Fundadora da Solaris Nutri · Criadora do Solaris Nutri Framework",
